...
const ExperienceSection = () => {
  const experience = {
    ...
    description: "Developed responsive, accessible web applications using modern frontend technologies, focusing on performance optimization and user experience.",
    projects: [
      {
        name: "Scholastic Art and Writing",
        description: "Created a platform for students to share art and writing with full accessibility compliance",
      ...
      },
      {
        ...
        description: "Led development of pixel-perfect, responsive web pages with SSR capabilities",
      ...
      {
        name: "Curio",
        description: "Developed a digital marketplace for curated handmade furniture and art from 100+ global artisans",
        technologies: ["React.js", "Next.js", "Tailwind CSS", "Frontastic", "Contentstack", "jsPDF"],
        achievements: [
              ...
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between flex-wrap gap-4">
                  <div>
                    ...
                    <p className="text-xl font-semibold text-primary mt-2">{experience.position}</p>
                  </div>
