  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive platform enabling students to share and showcase their artistic and written works. Built with accessibility-first approach following WCAG standards.",
    ...
    },
    {
      ...
      description:
        "Pixel-perfect, responsive e-commerce website with server-side rendering for optimal performance and SEO. Integrated with Frontastic headless commerce platform.",
    ...
    },
    {
      ...
      description:
        "A sophisticated digital marketplace connecting over 100 global artisans with customers seeking unique handmade furniture, lighting, and art pieces.",
  ...
  return (
    <section id="projects" className="py-20 bg-background">
      <div className="container mx-auto px-4 py-20 sm:py-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 sm:grid-cols-1 sm:gap-4">
        ...
        >
          <Card className="border-0 shadow-lg bg-gradient-to-r from-primary/5 to-secondary/5">
            <CardContent className="p-8 sm:p-4">
              <h3 className="text-2xl font-bold text-foreground mb-4 sm:text-xl">
                Interested in Working Together?
              </h3>
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto sm:text-base">
                I'm always excited to take on new challenges and collaborate on
                innovative projects. Let's discuss how we can bring your ideas
                to life!
              </p>
              <Button
                className="btn-gradient text-white font-medium px-8 py-3 sm:px-4 sm:py-2"
                onClick={() =>
                  document
